...
This command will aggregate the results of however many output files are matched by the shell glob, and write those results to a document with the same kind of summary as the normal cuke output.
